...
func (s *IntegrationTestSuite) TestCmdParams() {
	...
	testCases := []struct {
	...
	}{
		{
            ...
            fmt.Sprintf(`{"voting_params":{"voting_period":"172800000000000"},"tally_params":{"quorum":"0.334000000000000000","threshold":"0.500000000000000000","veto_threshold":"0.334000000000000000"},"deposit_params":{"min_deposit":[{"denom":"%s","amount":"10000000"}],"max_deposit_period":"172800000000000"}, "min_expedited_deposit":[{"denom":"%s","amount":"20000000"}]}`,
                sdk.MustGetBaseDenom(), sdk.MustGetBaseDenom()),
		},
		{
			"text output",
			[]string{},
...
func (s *IntegrationTestSuite) TestCmdParam() {
	...
	testCases := []struct {
		...
		},
		{
            ...
            fmt.Sprintf(`{"min_deposit":[{"denom":"%s","amount":"10000000"}],"max_deposit_period":"172800000000000", "min_expedited_deposit":[{"denom":"%s","amount":"20000000"}]}`,
                sdk.MustGetBaseDenom(), sdk.MustGetBaseDenom()),
		},
	}
