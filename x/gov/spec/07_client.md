...
```bash
simd tx gov submit-proposal --title="Test Proposal" --description="testing, testing, 1, 2, 3" --type="Text" --deposit="10000000<base_denom>" --from cosmos1..
```

Example (`cancel-software-upgrade`):

```bash
simd tx gov submit-proposal cancel-software-upgrade --title="Test Proposal" --description="testing, testing, 1, 2, 3" --deposit="10000000<base_denom>" --from cosmos1..
```
