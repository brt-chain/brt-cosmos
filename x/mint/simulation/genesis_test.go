...
func TestRandomizedGenState(t *testing.T) {
    ...
    require.Equal(t, sdk.MustGetBaseDenom(), mintGenesis.Params.MintDenom)
    require.Equal(t, "0"+sdk.MustGetBaseDenom(), mintGenesis.Minter.BlockProvision(mintGenesis.Params).String())
