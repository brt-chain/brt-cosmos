...
func (suite *IntegrationTestSuite) TestSendCoinsAndWei() {
	...
	// should just do base denom send if wei is zero
	...
	// sender gets escrowed one base denom, recipient does not get redeemed
...
func (suite *IntegrationTestSuite) TestSpendableCoins() {
	...
	origCoins := sdk.NewCoins(sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 100))
	delCoins := sdk.NewCoins(sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 50))
...
func (suite *IntegrationTestSuite) TestVestingAccountSend() {
	...
	origCoins := sdk.NewCoins(sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 100))
	sendCoins := sdk.NewCoins(sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 50))
...
func (suite *IntegrationTestSuite) TestPeriodicVestingAccountSend() {
	...
	periods := vesting.Periods{
		vesting.Period{Length: int64(12 * 60 * 60), Amount: sdk.Coins{sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 50)}},
		vesting.Period{Length: int64(6 * 60 * 60), Amount: sdk.Coins{sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 25)}},
		vesting.Period{Length: int64(6 * 60 * 60), Amount: sdk.Coins{sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 25)}},
	}
...
func (suite *IntegrationTestSuite) TestDelegateCoinsFromAccountToModule() {
	...
	origCoins := sdk.NewCoins(sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 100))
	delCoins := sdk.NewCoins(sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 50))
	undelCoins := sdk.NewCoins(sdk.NewInt64Coin(sdk.MustGetBaseDenom(), 20))
...
func (suite *IntegrationTestSuite) TestCanSendTo() {
	...
	suite.Require().NoError(simapp.FundAccount(app.BankKeeper, ctx, sourceAddr, sdk.NewCoins(sdk.NewCoin(sdk.MustGetBaseDenom(), sdk.NewInt(100)))))
	...
	amt := sdk.NewCoins(sdk.NewCoin(sdk.MustGetBaseDenom(), sdk.NewInt(10)))
