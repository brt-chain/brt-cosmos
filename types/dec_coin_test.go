...
func (s *decCoinTestSuite) TestParseDecCoins() {
	testCases := []struct {
        ...
        {"", nil, false},
        {"4"+sdk.MustGetBaseDenom(), sdk.DecCoins{sdk.NewDecCoinFromDec(sdk.MustGetBaseDenom(), sdk.NewDecFromInt(sdk.NewInt(4)))}, false},
        {"5.5atom,4"+sdk.MustGetBaseDenom(), sdk.DecCoins{
			sdk.NewDecCoinFromDec("atom", sdk.NewDecWithPrec(5500000000000000000, sdk.Precision)),
            sdk.NewDecCoinFromDec(sdk.MustGetBaseDenom(), sdk.NewDec(4)),
		}, false},
        {"0.0"+sdk.MustGetBaseDenom(), sdk.DecCoins{}, false}, // remove zero coins
		{"10.0btc,1.0atom,20.0btc", nil, true},
		{
            "0.004"+sdk.MustGetBaseDenom(),
            sdk.DecCoins{sdk.NewDecCoinFromDec(sdk.MustGetBaseDenom(), sdk.NewDecWithPrec(4000000000000000, sdk.Precision))},
			false,
		},
		{
            "0.004"+sdk.MustGetBaseDenom(),
		...
		{
            "5.04atom,0.004"+sdk.MustGetBaseDenom(),
			sdk.DecCoins{
				sdk.NewDecCoinFromDec("atom", sdk.NewDecWithPrec(5040000000000000000, sdk.Precision)),
                sdk.NewDecCoinFromDec(sdk.MustGetBaseDenom(), sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
			false,
		},
        {"0.0"+sdk.MustGetBaseDenom()+",0.004"+sdk.MustGetBaseDenom()+",5.04atom", // remove zero coins
			sdk.DecCoins{
				sdk.NewDecCoinFromDec("atom", sdk.NewDecWithPrec(5040000000000000000, sdk.Precision)),
                sdk.NewDecCoinFromDec(sdk.MustGetBaseDenom(), sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
...
func (s *decCoinTestSuite) TestDecCoinsString() {
	testCases := []struct {
		...
		{sdk.DecCoins{}, ""},
		{
            ...
            "5.040000000000000000atom,0.004000000000000000"+sdk.MustGetBaseDenom(),
		},
	}
...
func (s *decCoinTestSuite) TestDecCoinsIntersect() {
	testCases := []struct {
        ...
        {"", "", ""},
        {"1.0"+sdk.MustGetBaseDenom(), "", ""},
        {"1.0"+sdk.MustGetBaseDenom(), "1.0"+sdk.MustGetBaseDenom(), "1.0"+sdk.MustGetBaseDenom()},
        {"", "1.0"+sdk.MustGetBaseDenom(), ""},
        {"1.0"+sdk.MustGetBaseDenom(), "", ""},
        {"2.0"+sdk.MustGetBaseDenom()+",1.0trope", "1.9"+sdk.MustGetBaseDenom(), "1.9"+sdk.MustGetBaseDenom()},
        {"2.0"+sdk.MustGetBaseDenom()+",1.0trope", "2.1"+sdk.MustGetBaseDenom(), "2.0"+sdk.MustGetBaseDenom()},
        {"2.0"+sdk.MustGetBaseDenom()+",1.0trope", "0.9trope", "0.9trope"},
        {"2.0"+sdk.MustGetBaseDenom()+",1.0trope", "1.9"+sdk.MustGetBaseDenom()+",0.9trope", "1.9"+sdk.MustGetBaseDenom()+",0.9trope"},
        {"2.0"+sdk.MustGetBaseDenom()+",1.0trope", "1.9"+sdk.MustGetBaseDenom()+",0.9trope,20.0other", "1.9"+sdk.MustGetBaseDenom()+",0.9trope"},
        {"2.0"+sdk.MustGetBaseDenom()+",1.0trope", "1.0other", ""},
        {"2.0"+sdk.MustGetBaseDenom()+",1.0trope", "0.9trope,20.0other,1.9"+sdk.MustGetBaseDenom(), "1.9"+sdk.MustGetBaseDenom()+",0.9trope"},
	}
